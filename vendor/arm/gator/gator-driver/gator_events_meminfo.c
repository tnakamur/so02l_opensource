...
/*
 * Manual expansion of below macro is needed to avoid compiler warnings
 * See http://lists.llvm.org/pipermail/cfe-commits/Week-of-Mon-20160104/146059.html
 */
...
#define GLOBAL_ZONE_PAGE_STATE(item)    global_node_page_state(item) // this should be used if NR_FILE_PAGES is argument
#endif
